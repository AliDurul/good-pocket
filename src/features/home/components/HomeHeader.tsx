...
export function HomeHeader({
  ...
  return (
    <HStack className="items-center justify-between px-4 pb-3 pt-2">
      <VStack>
        <Text className="font-poppins-medium text-base text-muted-foreground">{greeting}</Text>
        <Text className="font-poppins-semibold text-xl text-foreground">{name} 👋</Text>
      </VStack>
